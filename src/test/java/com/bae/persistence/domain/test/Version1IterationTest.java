...
//
//		newHike = new Hiking("File/Area", "long hike, feet hurt", "field", "2019-06-04T00:00:00.000Z",
//				"2019-06-04T00:00:00.000Z", 10, "Hilly Hike");
//		newerHike = new Hiking("File/Area2", "longer hike, feet hurt more", "hill", "2019-06-04T00:00:00.000Z",
//				"2019-06-04T00:00:00.000Z", 10, "Hillier Hike");
//		newestHike = new Hiking("File/Area3", "longest hike, feet in agony", "mountain",
//				"2019-06-04T00:00:00.000Z", "2019-06-04T00:00:00.000Z", 10, "Hilliest Hike");
//		newPaddle = new Kayaking("File/Area4", "gentle paddle", "Potato Wharf", "Anchorage","2019-06-04T00:00:00.000Z", 120, 50);
//		returnPaddle = new Kayaking("File/Area5", "gentler paddle", "Anchorage", "Potato Wharf",
//				"2019-06-04T00:00:00.000Z", 150, 50);
//
...
//		assertEquals("Tue Jun 04 00:00:00 BST 2019", ((Hiking) hikingList.get(0)).getStartDate().toString());
//
//	}
//
//	@Test
...
//		assertEquals("Tue Jun 04 00:00:00 BST 2019", ((Kayaking) kayakingList.get(0)).getDateCompleted().toString());
//	}
//
//	@Test
...
//		assertEquals(
//				"Hiking [location=field, startDate=Tue Jun 04 00:00:00 BST 2019, endDate=Tue Jun 04 00:00:00 BST 2019, lengthMiles=10, officialRouteName=Hilly Hike]",
...
//		assertEquals(
//				"Hiking [location=mountain, startDate=Tue Jun 04 00:00:00 BST 2019, endDate=Tue Jun 04 00:00:00 BST 2019, lengthMiles=10, officialRouteName=Hilliest Hike]",
//				newUser.getActivityList().get(0).toString());
//	}
//
//	@Test
...
//		assertEquals(
//				"Kayaking [journeyStart=Potato Wharf, journeyEnd=Anchorage, dateCompleted=Tue Jun 04 00:00:00 BST 2019, durationMins=120]",
...
//		assertEquals(
//				"Kayaking [journeyStart=Anchorage, journeyEnd=Potato Wharf, dateCompleted=Tue Jun 04 00:00:00 BST 2019, durationMins=150]",
//				newUser.getActivityList().get(2).toString());
//	}
//
//	// Delete
