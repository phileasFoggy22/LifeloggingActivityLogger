...
function recentActivities(userEmail) {
    makeRequest("GET", URLstring + "activities/getAllActivities/" + userEmail, "").then((resolve) => {
        ...
        for (var i = 0; i < newobj1.length; i++) {
            ...
            //location
            var h6loc = document.createElement("h5");
            var h6locInput = document.createElement("input");
            ...
            //distance
            var h6miles = document.createElement("h5");
            var h6milesInput = document.createElement("input");
            ...
            col1b.className = "col-xs-12";
            //description
            var pdesc = document.createElement("p");
            var pdescInput = document.createElement("input");
            ...
            row4.className = "row";
            var col1d = document.createElement("DIV");
            col1d.className = "col-xs-10";
            //file directory
            var fdir = document.createElement("h6");
            var fdirInput = document.createElement("input");
